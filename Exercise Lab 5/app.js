...
const Card = (props) => {
  ...
  <div className="card">
    ...
    <button className='remove' onClick={() => props.removePlanet(props.id)}>Remove me</button>
  </div>
  )
}
  ...
  render(){
    ...
    <div className='container'> 
        {this.state.planets.map(
          planet => <Card id={planet.id} name={planet.name} desc={planet.desc} diameter={planet.diameter} moons={planet.moons}  url={planet.url} 
